                              ...
                              <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                ...
                                <?php if(!empty($progress)): ?>
                                    ...
                                    <div class="about-home-btn">
                                        <a href="<?php echo e(route('cirtificate.show', $course->id)); ?>" class="btn btn-secondary" href="#">Get Certificate</a>
                                    </div>
                                    <?php endif; ?>
                                <?php endif; ?>
                              </div>
                                ...
                                <div class="learning-questions-block btm-40">
                                    ...
                                    <?php else: ?>
                                        ...
                                        <div class="learning-questions-dtl-block">
                                            <div class="learning-questions-img rgt-20"><?php echo e(str_limit($question->user->fname, $limit = 1, $end = '')); ?><?php echo e(str_limit($question->user->lname, $limit = 1, $end = '')); ?></div>
                                        ...
                                        <div class="content-img-block btm-20">
                                            <div class="content-img">
                                                ...
                                                <?php if($course->user->user_img != null || $course->user->user_img !=''): ?>
                                                  <a href="<?php echo e(route('instructor.profile', $course->user->id)); ?>" title="profile"><img src="<?php echo e(asset('images/user_img/'.$course->user->user_img)); ?>" class="img-fluid"  alt="instructor" ></a>
                                                <?php else: ?>
                                                    <a href="<?php echo e(route('instructor.profile', $course->user->id)); ?>" title="profile"><img src="<?php echo e(asset('images/default/user.jpg')); ?>" class="img-fluid" alt="instructor"></a>
                                                <?php endif; ?>
                                            </div>
                                            <div class="content-img-dtl">
                                                <div class="profile"><a href="<?php echo e(route('instructor.profile', $course->user->id)); ?>" title="profile"><?php echo e($course->user->fname); ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="class-type">
                                                        ...
                                                        <?php if($class->url): ?>
                                                            ...
                                                            <a href="<?php echo e(route('audiocourseclass',$class->id)); ?>" title="Course" class="<?php if($z == 0): ?>iframe <?php endif; ?>"><i class="fa fa-play-circle" >&nbsp;<?php echo e(__('frontstaticword.class')); ?></i></a>
                                                            <?php endif; ?>
                                                        <?php endif; ?> 
                                                    </td>
                                                ...
                                                <button class="btn btn-link" data-toggle="collapse" data-target="#collapseThree<?php echo e($ques->id); ?>" aria-expanded="true" aria-controls="collapseThree">
                                                    ...
                                                    <div class="row no-gutters">
                                                        <div class="col-lg-8 col-8"> 
                                                            <div class="profile-heading profile-heading-two"><?php echo e($ques->question); ?>
                                                                    ...
                                                                    <ul>
                                                                        <li>
                                                                            ...
                                                                            <div class="instructor-img btm-30">
                                                                                ...
                                                                                <a href="<?php echo e(route('instructor.profile', $course->user->id)); ?>" title="instructor"><img src="<?php echo e(asset('images/user_img/'.$appoint->instructor->user_img)); ?>" width="100px" height="100px" class="img-fluid img-circle"/></a>
                                                                                <?php else: ?>

                                                                                <a href="<?php echo e(route('instructor.profile', $course->user->id)); ?>" title="instructor"><img src="<?php echo e(asset('images/default/user.jpg')); ?>" width="100px" height="100px" class="img-fluid img-circle"/></a>
                                                                                <?php endif; ?>
                                                                            </div>
                                                                        </li>
                                                                        <li>
...
<?php echo $__env->make('theme.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/cherif/Desktop/PFELearning/resources/views/front/course_content.blade.php ENDPATH**/ ?>