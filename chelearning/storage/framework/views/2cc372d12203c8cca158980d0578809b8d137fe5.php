            ...
            <div class="col-lg-3 col-sm-6">
                <div class="categories-block">
                    <ul>
                        ...
                        <li><a href="<?php echo e(route('childcategory.page',$cat->id)); ?>"><?php echo e($cat->title); ?></a></li>
                    </ul>
                </div>  
            </div>
            <?php endif; ?>
...
<section id="instructors" class="instructors-main-block btm-40">
    <div class="container">
        ...
        <h4 class="btm-40"><?php echo e(__('frontstaticword.PopularInstructors')); ?></h4>
                    ...
                    <div class="item testimonial-block text-center btm-30">
                        <div class="instructors-img-block btm-20">
                            <?php if($user['user_img'] != null || $user['user_img'] !=''): ?>
                                <a href="<?php echo e(route('instructor.profile', $user->id)); ?>" title="instructor"><img src="<?php echo e(asset('images/user_img/'.$user['user_img'])); ?>" alt="User"></a>
                            <?php else: ?>
                                <a href="<?php echo e(route('instructor.profile', $user->id)); ?>" title="instructor"><img src="<?php echo e(asset('images/default/user.jpg')); ?>" class="user-image" alt="User Image"></a>
                            <?php endif; ?>
                        </div>
                        <div class="instructors-dtl">
                            <ul>
                                ...
                                <li>
                                    ...
                                    ?>
                                    <?php echo e(__('frontstaticword.Courses')); ?>
...
<section id="categories-popularity" class="categories-popularity-main-block">
    <div class="container">
    	<h2 class="btm-40"><?php echo e($cats->title); ?> <?php echo e(__('frontstaticword.Courses')); ?></h2>
        <div class="row">
            <div class="col-lg-9">
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="categories-popularity-dtl">
                                    ...
                                    <ul>
                                        ...
                                        <li><?php echo e(__('frontstaticword.AllLevels')); ?></li>
                                    </ul>
...
<?php echo $__env->make('theme.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/cherif/Desktop/PFELearning/resources/views/front/category.blade.php ENDPATH**/ ?>