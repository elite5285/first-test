					                            ...
					                            <div class="cart-course-amount">
					                                <ul>
			                                            ...
			                                            <?php if($cart->offer_price == !NULL): ?>
					                                    	...
					                                    	<li><i class="<?php echo e($currency->icon); ?>"></i><?php echo e($cart->offer_price); ?></li>
					                                    	<li><s><i class="<?php echo e($currency->icon); ?>"></i><?php echo e($cart->price); ?></s></li>
					                                    <?php else: ?>
					                                    	<li><i class="<?php echo e($currency->icon); ?>"></i><?php echo e($cart->price); ?></li>
					                                    <?php endif; ?>
...
<?php echo $__env->make('theme.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/cherif/Desktop/PFELearning/resources/views/front/cart.blade.php ENDPATH**/ ?>