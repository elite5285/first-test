            ...
            <div class="row">
              <div class="col-md-3">
                ...
                <li class="tg-list-item">
                  <input class="tgl tgl-skewed" id="verified"  type="checkbox"  <?php echo e($user->email_verified_at != NULL ? 'checked' : ''); ?>>
                <label class="tgl-btn" data-tg-off="No" data-tg-on="Yes" for="verified"></label>
                </li>
                <input type="hidden" name="verified" value="<?php echo e($user->verified); ?>" id="verified">
              </div>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/cherif/Desktop/PFELearning/resources/views/admin/user/edit.blade.php ENDPATH**/ ?>