...
<head>
  ...
  ?>
    ...
    <meta name="description" content="<?php echo e($met->meta_data_desc); ?>">
    <meta name="keywords" content="<?php echo e($met->meta_data_keyword); ?>">
  ...
  <div class="wrapper">
    ...
    <footer class="main-footer">
      <div class="pull-right hidden-xs">
        <?php echo e($project_title); ?> <?php if(Auth::user()->role == "admin"): ?> (<?php echo e(config('app.version')); ?>) <?php endif; ?>
      </div>
     <?php echo e($cpy_txt); ?> 
    </footer>
    <!-- /.control-sidebar -->
...
<?php /**PATH /Users/cherif/Desktop/chelearning/resources/views/admin/layouts/master.blade.php ENDPATH**/ ?>