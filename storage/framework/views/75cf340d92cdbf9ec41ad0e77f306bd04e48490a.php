                ...
                <div class="about-home-product">
                    ...
                    <div class="about-home-dtl-training">
                        ...
                        <div class="about-home-share text-center">
                            <a href="#" data-toggle="modal" data-target="#myModalshare" title="share"><i class="fa fa-share rgt-10"></i><?php echo e(__('frontstaticword.share')); ?></a>
                        </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="product-learn-dtl">
                                    <ul>
                                        <li><i class="flaticon-tick-inside-circle"></i><?php echo e(str_limit($wl['detail'], $limit = 120, $end = '...')); ?></li>
                                    </ul>
                                </div>
                            </div>
                            <?php endif; ?>
                                            ...
                                            <button class="btn btn-link" data-toggle="collapse" data-target="#collapseTwo<?php echo e($chapter->id); ?>" aria-expanded="false" aria-controls="collapseTwo">
                                                ...
                                                <div class="col-lg-8 col-6">
                                                    ...
                                                    <?php if($course->involvement_request == 1): ?>
                                                        ...
                                                        <a href="<?php echo e(route('instructor.profile', $chapter->user->id)); ?>">- by <?php echo e($chapter->user['fname']); ?> </a>
                                                        <?php endif; ?>
                                                    <?php endif; ?>
                                                </div>
                ...
                <?php if( $user_enrolled != NULL || Auth::user()->role == 'admin' ): ?>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <tbody>
                                        <td>
                                          <ul>
                                            <li><a href="#" title="about"><?php echo e(__('frontstaticword.Created')); ?>: <?php echo e($bbl->user['fname']); ?> </a></li>
                                ...
                                <div class="card-body">
                                    ...
                                    <tbody>
                                        <td>
                                            <ul>
                                                <li>
                                                    <a href="#" title="about"><?php echo e(__('frontstaticword.Created')); ?>: <?php echo e($meeting->user['fname']); ?> </a>
                                ...
                                <?php if($item->type==1): ?>
                                    ...
                                    <?php if($item->discount_price == !NULL): ?> 
                                        <div class="course-currency txt-rgt">
                                            <ul>
                                                <li class="rate"><i class="<?php echo e($currency['icon']); ?>"></i><?php echo e($item->discount_price); ?></li>
                                                <li class="rate"><s><i class="<?php echo e($currency['icon']); ?>"></i><?php echo e($item['price']); ?></s></li>
                                            </ul>
                                        </div>
                                    <?php else: ?>
                                        <div class="course-currency txt-rgt">
                                            <ul>
                                                <li><i class="<?php echo e($currency['icon']); ?>"></i><?php echo e($item['price']); ?></li>
                                            </ul>
                                        </div>
                                    <?php endif; ?>
                                <?php else: ?>
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-sm-4">
                                <div class="instructor-img btm-30">
                                    <?php if($course->user->user_img != null || $course->user->user_img !=''): ?>
                                      <a href="<?php echo e(route('instructor.profile', $course->user->id)); ?>" title="instructor"><img src="<?php echo e(asset('images/user_img/'.$course->user['user_img'])); ?>" class="img-fluid" alt="instructor"></a>
                                    <?php else: ?>
                            ...
                            <div class="col-lg-8 col-sm-8">
                                <div class="instructor-block">
                                    <div class="instructor-name btm-10"><a href="<?php echo e(route('instructor.profile', $course->user->id)); ?>" title="instructor-name"><?php echo e($course->user['fname']); ?></a></div>
                                            ...
                                            <?php if( $rel->courses->type == 1): ?>
                                                ...
                                                <?php if($rel->courses->discount_price == !NULL): ?>
                                                    <div class="rate text-right">
                                                        <ul>
                                                            <li><a><b><i class="<?php echo e($currency['icon']); ?>"></i><?php echo e($rel->courses['discount_price']); ?></b></a></li>&nbsp;
                                                            <li><a><b><strike><i class="<?php echo e($currency['icon']); ?>"></i><?php echo e($rel->courses['price']); ?></strike></b></a></li>
                                                        </ul>
                                                    </div>
                                                <?php else: ?>
                                                    <div class="rate text-right">
                                                        <ul>
                                                            <li><a><b><i class="<?php echo e($currency['icon']); ?>"></i><?php echo e($rel->courses['price']); ?></b></a></li>
                                                        </ul>
                                                    </div>
                                                <?php endif; ?>
                                            <?php else: ?>
...
<?php echo $__env->make('theme.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/cherif/Desktop/PFELearning/resources/views/front/course_detail.blade.php ENDPATH**/ ?>